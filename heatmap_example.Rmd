...
## Goal
Plot a heatmap of a random matrix of $n \times m$ elements
...
nc <- 2
nr <- 3
matrix_example <- matrix(runif(nr * nc, -1, 1), nr, nc)
...
text(nc / 2, nr / 2, "matrix_example")
text(nc / 2, nr / 2 - 0.5, matrix_text)
par(op)
```
